# 🎯 ClawBoz Project Missions - 2026-02-17
...
**📊 Difficulty:** Advanced  
**🛠️ Tools:** discord.py, requests, tmdbsimple
...
async def request_media(ctx, title: str):
    ...
    if result:
        ...
        if media.request_media(result):
            embed.add_field(name="Status", value="✅ Request submitted", inline=False)
        else:
            embed.add_field(name="Status", value="❌ Request failed", inline=False)
            
        await ctx.followup.send(embed=embed)
    else:
        await ctx.followup.send("❌ Could not find that title. Please try again.")
